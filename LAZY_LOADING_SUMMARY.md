...
- `docs/LazyLoadingOptimization.md` - Technical details and architecture
- `docs/LazyLoadingMigrationGuide.md` - Step-by-step migration guide
...
See `docs/LazyLoadingMigrationGuide.md` for detailed examples of updating:
...
- `docs/LazyLoadingOptimization.md` - Technical documentation
- `docs/LazyLoadingMigrationGuide.md` - Migration guide
- `src/hooks/__tests__/useViewportObstacles.test.ts` - Unit tests
